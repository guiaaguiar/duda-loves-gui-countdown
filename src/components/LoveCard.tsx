...
const LoveCard = ({ onSurpriseClick }: LoveCardProps) => {
  ...
  return (
    <main className="glass-card rounded-3xl p-8 md:p-12 my-10 text-center transition-all duration-500 float-animation">
      <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold gradient-text-gold mb-10">
        Minha Alma Gêmea 💕
      </h2>

      <div className="text-lg md:text-xl text-silver font-light leading-relaxed mb-12 message-glow">
        <p>
      ...
      <Button
        ...
        className="btn-glow shine-effect text-foreground font-semibold text-lg md:text-xl px-10 md:px-14 py-6 md:py-7 rounded-full cursor-pointer transition-all duration-300 my-10"
      >
        ✨ Uma Surpresa Especial Para Você ✨
      </Button>

      <div
        className={`glass-card rounded-3xl p-8 md:p-12 mt-10 border-2 border-primary/30 transition-all duration-700 relative overflow-hidden ${
          showSpecialMessage
      ...
      >
        ...
        <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold gradient-text-special mb-8 relative z-10">
          💖 Do Fundo Do Meu Coração 💖
        </h3>
        <p className="text-silver text-base md:text-lg leading-relaxed text-center font-light relative z-10">
